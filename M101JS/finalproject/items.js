...
function ItemDAO(database) {
    ...
    this.getCategories = function(callback) {
        ...
        */
		...
		this.db.collection("item").aggregate([ { $group : {_id:"$category", num:{$sum:1}}}, {$sort:{_id:1}} ]).toArray() ( function(err, categories) {
		...
		//while (categoriesFromDB.hasNext()) {
			//var categoryFromDB = categoriesFromDB.next();
		//	categories.push(categoriesFromDB.next());
			//i++;
			//console.log(i);
		//}
